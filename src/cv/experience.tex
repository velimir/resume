...
\begin{cventries}
  \cventry
    ...
    {Aug 2022 – PRESENT} % Date(s)
    {
      ...
      \begin{cvitems} % Specific tasks/responsibilities with tech and numbers
...
%---------------------------------------------------------
  \cventry
    {Erlang Developer} % Job title
    {Erlang Solutions} % Organization
    {London, United Kingdom} % Location
